...
to get-sick
  ask healthies [
    if count sicks-on neighbors > 0 [
      if random-float 100 < probability-of-getting-sick [ set energy random-float 4 + 8 ]
    ]
  ]
  ask healthies [
    if energy <= 0 [
...
WHAT IS IT?
-----------
This is a SEIR (susceptible-exposed-infected-removed) model for the spread of an infectious disease.


HOW IT WORKS
------------
If a person touches another sick person, the person will become sick after about ten ticks.  A sick person will recover and become immune after about ten ticks also.
...
----------------------
Please read the article "BMC Infectious Diseases" that is on this website: http://www.biomedcentral.com/1471-2334/3/19.
@#$#@#$#@
default
true
0
