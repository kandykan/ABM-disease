...
WHAT IS IT?
-----------
This is a SIR (susceptible-infected-removed) model for a contagious disease.


HOW IT WORKS
------------
A person will become sick by touching another sick person.  A sick person will recover a tick later.
...
----------------------
This wikipedia article elaborates more on the SIR model: http://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology.
@#$#@#$#@
default
true
0
